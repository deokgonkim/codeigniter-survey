	<h1>이용안내 보기</h1>
	<div id="body">
		<span id="button_bar"><?php echo anchor('preference/notices', '목록', ''); ?></span>
		<div id="notice_view">
			...
			<div class="bbs_title even_row">
				...
				if ( $notice->attach1_name ) {
					echo anchor('preference/notice_file/' . $notice->id . '/' . $notice->attach1_name, $notice->attach1_name, '');
				}
				if ( $notice->attach2_name ) {
					echo anchor('preference/notice_file/' . $notice->id . '/' . $notice->attach2_name, $notice->attach2_name, '');
				}
				if ( $notice->attach3_name ) {
					echo anchor('preference/notice_file/' . $notice->id . '/' . $notice->attach3_name, $notice->attach3_name, '');
				}
				?></span>
			</div><!--/div.bbs_title-->
